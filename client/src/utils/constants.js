...
export const PICKUP_SLOTS = [
  { id: 's1', label: 'Today · 4:00 – 5:00 PM', sub: 'TUC Cafeteria' },
  { id: 's2', label: 'Today · 6:00 – 7:00 PM', sub: 'Central Library' },
  { id: 's3', label: 'Tomorrow · 11:00 AM – 12:00 PM', sub: 'FCSE Faculty' },
  { id: 's4', label: 'Tomorrow · 4:00 – 5:00 PM', sub: 'Hostel 1 entrance' },
];
